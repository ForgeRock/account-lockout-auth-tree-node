...
-->
# account-lockout-auth-tree-node

## About

A simple authentication node for ForgeRock's [Identity Platform][forgerock_platform] 5.5 and above. This node locks an account. It updates the `inetuserstatus` to "Inactive" for the username in the sharedstate.
